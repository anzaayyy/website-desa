...
<head>
  ...
  <title><?= esc($meta_title ?? 'Website Desa') ?></title>
  <meta name="description" content="<?= esc($meta_desc ?? 'Website resmi desa yang menyajikan informasi, agenda, dan layanan masyarakat.') ?>">
